...
\item 
struct \hyperlink{structtable__info}{table\_\-info}
\begin{DoxyCompactList}\small\item\em A struct to store each table's configuration type. \item\end{DoxyCompactList}\item 
struct \hyperlink{structconfig__params}{config\_\-params}
\begin{DoxyCompactList}\small\item\em A struct to store config parameters. Includes table names and the struct \hyperlink{structtable__info}{table\_\-info}. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Defines}
\begin{DoxyCompactItemize}
\item 
...
void \hyperlink{utils_8h_a9e4d8cb085fc7d5c9093ee102fa886d1}{logger} (FILE $\ast$file, char $\ast$message)
...
\hypertarget{utils_8h_a9e4d8cb085fc7d5c9093ee102fa886d1}{
...
\begin{DoxyParams}{Parameters}
\item[{\em config\_\-file}]The name of the configuration file./homes/l/loboweyl/Documents/storage/src/server.c:117: undefined reference to `set\_\-function' \item[{\em params}]The structure where config parameters are loaded. \end{DoxyParams}
\begin{DoxyReturn}{Returns}
